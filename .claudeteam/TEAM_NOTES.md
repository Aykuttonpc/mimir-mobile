...
- **✅ NGINX /mimir/ PATCH KALICI** — Sprint #3 T-018 (2026-05-09) ile AykutOnPC repo'sunda commit `7c58362`. Artık her AykutOnPC deploy'unda git tracked olarak yansır, `git reset --hard` etkilemez. Mimir backend + AykutOnPC ortak yaşamı sürdürülebilir. Local snapshot: `D:\Projeler\mimir-api\deployment\nginx\aykutonpc.conf.snapshot` (audit/karşılaştırma için).
